...
local I18N = {
    ...
    menu_trade_alerts = {
        ...
        ru = "Losing Trade Alerts",
        cn = "对拼劣势提醒",
    },
    menu_dive_alerts = {
        en = "Tower Dive Alerts",
        ru = "Tower Dive Alerts",
        cn = "塔下强杀提醒",
    },
    menu_gank_alerts = {
        en = "Gank Alerts",
    ...
    menu_alert_duration = {
        ...
        ru = "Alert Duration (ms)",
        cn = "提醒持续时间 (ms)",
    },
    menu_visible_only = {
        en = "Visible Enemies Only",
        ru = "Visible Enemies Only",
        cn = "仅可见敌人",
    },
    menu_debug_draw = {
        en = "Debug Draw",
    ...
    dbg_tp_status = {
        ...
        ru = "TP: kind=%s usable=%s reason=%s",
