...
local function createMenuGroup()
    local function tryFindBuiltInCourierGroup()
        ...
        local thirdCandidates = { "Courier", "Main" }
        local groupCandidates = { "Courier", "Main", "Settings" }
...
local WORK_FROM_MIN = ADVANCED_GROUP:Slider("Work from minute", 0, 99, 0, "%d")
local WORK_UNTIL_MIN = ADVANCED_GROUP:Slider("Work until minute", 0, 99, 99, "%d")
